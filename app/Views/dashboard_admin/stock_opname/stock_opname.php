        ...
        <div class="app-card-body p-3">
            <div class="row g-4 mb-4">
                <div class="col-lg-6">
                    ...
                    <input type="date" class="form-control" style="width:50%" id="tanggal" name="tanggal" placeholder="Tanggal">
                </div>
                <!--//col-->
                <div class="col-lg-6">
            ...
            <div class="">
                <button type="button" class="btn btn-primary text-white">Unduh</button>
                <button type="button" class="btn btn-danger text-white">Reset</button>
            </div>
        </div>
    </div>
